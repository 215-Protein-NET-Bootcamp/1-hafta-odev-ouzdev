...
namespace CurrencyConverterAPI.Adapters.ExchangeRatesService
{
    public class ExchangeRateManager : IExchangeRateService
    {
        ...
        public async Task<IDataResult<ExchangeRateResponse>> ConvertCurrency(GetConvertCurrencyRequest currencyRate)
        {
        ...
        public async Task<IDataResult<ExchangeLatestResponse>> GetLatestCurrency(GetLatestCurrencyRequest latestCurrencyRate)
        {
            var httpClient = _httpClientFactory.CreateClient("ExchangeRateData");
